ALTER PROCEDURE [tSQL_test_synapse].AssertNoSideEffects
...
BEGIN
    ...
    BEGIN
        SELECT @message = STRING_AGG(CONCAT('Status: ', Status, ' ObjectId: ', CAST(ObjectId AS NVARCHAR(100)), ' SchemaName: ', SchemaName, ' ObjectName: ', ObjectName, ' ObjectType: ',  ObjectType COLLATE SQL_Latin1_General_CP1_CI_AS), CHAR(13)) FROM #ObjectDiscrepancies;
        SET @message = 'After the test [' + @test_name + '] executed, there were unexpected or missing objects in the database' + CHAR(13) + @message;
